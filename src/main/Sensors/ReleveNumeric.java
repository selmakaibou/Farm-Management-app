public class ReleveNumeric extends ReleveSensor {
    protected NumericSensor sensor;
    protected final double MIN_BODY_TEMPERATURE = 35.0;
    protected final double MAX_BODY_TEMPERATURE = 42.0;
    protected final double MIN_ACTIVITY_LEVEL = 0.0;
    protected final double MAX_ACTIVITY_LEVEL = 10.0;
    protected final int MIN_STEPS_PER_MINUTE = 0;
    protected final int MAX_STEPS_PER_MINUTE = 200;
    protected final double MIN_WATER_TEMPERATURE = 0.0;
    protected final double MAX_WATER_TEMPERATURE = 35.0;
    protected final double MIN_DISSOLVED_OXYGEN = 0.0;
    protected final double MAX_DISSOLVED_OXYGEN = 14.0;
    protected final double MIN_WEATHER_TEMPERATURE = -40.0;
    protected final double MAX_WEATHER_TEMPERATURE = 60.0;
    protected final double MIN_HUMIDITY = 0.0;
    protected final double MAX_HUMIDITY = 100.0;
    protected final double MIN_RAINFALL = 0.0;
    protected final double MAX_RAINFALL = 500.0;
    protected final double MIN_PH = 0.0;
    protected final double MAX_PH = 14.0;
    protected final double MIN_MOISTURE_LEVEL = 0.0;
    protected final double MAX_MOISTURE_LEVEL = 100.0;
    protected final double MIN_NITROGEN_CONTENT = 0.0;
    protected final double MAX_NITROGEN_CONTENT = 100.0;
